...
import layer.SendApplicationLayer;
...
public class ExampleSender {
	...
	public static void main(String[] args) {
	    ...
	    Layer[] qos = {new UdpSimpleLayer(), new SendApplicationLayer()};
	    ...
	    SendApplicationSession sas = (SendApplicationSession) qos[qos.length - 1]
	        .createSession();
